...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        ...
        <div class="section">
            <asp:GridView ID="UserDataTable" CssClass="striped highlight" runat="server" AutoGenerateDeleteButton="true" OnRowDeleting="UserDataTable_RowDeleting" Width="100%"></asp:GridView><br /><br />
        </div>
        <div class="container">
