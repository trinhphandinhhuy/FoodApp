...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:RequiredFieldValidator ID="RfvUserName" runat="server" ErrorMessage="Username Required"
                ForeColor="#FF3300" ControlToValidate="txtUserName" Display="None"></asp:RequiredFieldValidator>
            <asp:RequiredFieldValidator ID="RfvEmail" runat="server" ErrorMessage="Email Required"
                ForeColor="#FF3300" ControlToValidate="txtEmail" Display="None"></asp:RequiredFieldValidator>
            <asp:RegularExpressionValidator ID="RxvEmail" runat="server" ControlToValidate="txtEmail"
                ErrorMessage="Invalid E-mail Address" ForeColor="#FF3300" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Display="None"></asp:RegularExpressionValidator>

                
            <asp:RequiredFieldValidator ID="RfvPwd" runat="server" ErrorMessage="Password Required"
                ForeColor="#FF3300" ControlToValidate="txtPassword" Display="None"></asp:RequiredFieldValidator>
               
 
            <asp:RequiredFieldValidator ID="RfvCnfrmPwd" runat="server" ErrorMessage="Confirm Password Required"
                ForeColor="#FF3300" ControlToValidate="txtConfirmPwd" Display="None"></asp:RequiredFieldValidator>
            <asp:CompareValidator ID="CvCnfmPwd" runat="server" ErrorMessage="Password and Confirm Password didn't matched"
                ForeColor="#FF3300" ControlToCompare="txtPassword" ControlToValidate="txtConfirmPwd" Display="None"></asp:CompareValidator>
